...
@keyframes glowing {
	...
	<div>
	<button class="glow-on-hover" type="button"onclick="window.location.href='https://replit.com/@inrlWorldwide/faz-md?v=1?outputonly=1&lite=1#index.js'">GET QR</button>
	<div>
	<br>
	<br>
	<br>
